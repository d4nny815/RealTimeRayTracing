...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { sclk_pmod }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sclk_pmod_IBUF]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { mosi }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { cs_n }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
